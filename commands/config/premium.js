        ...
        switch (type) {
          case "guild":
            code = voucher_codes.generate({
              pattern: `NGC-####-GUILD-DUR${args[2] || 7}`,
            });
          ...
          .reply({
            embeds: [
              new client.embed()
                ...
                .setThumbnail(client.user.displayAvatarURL()) // Added bot user avatar on the right top
                .desc(
                  `ㅤ\n` +
                    ...
                    `⠀⠀⠀28d Premium Subsscription 100 INR\n` +
